                            ...
                            <div class="flex items-center w-full bg-white rounded-sm p-4">
                                ...
                                <div class="items-center w-full">
                                    ...
                                    <div class="w-full flex justify-between">
                                        <div>
                                            <span class="text-blue-900 text-sm rounded-sm bg-gray-100 px-3">#{{ field.name }}</span>
                                            <span class="text-blue-900 text-sm rounded-sm bg-gray-100 px-3">
                                                {{ field.type }}
                                            ...
                                            <span class="text-blue-900 text-sm rounded-sm bg-gray-100 px-3" v-if="field.validations.required.status">required</span>
                                            <span class="text-blue-900 text-sm rounded-sm bg-gray-100 px-3" v-if="field.validations.unique.status">unique</span>
            ...
            <template #content>
                <div>
                    <form @submit.prevent="addNewFieldSubmit">
                        ...
                        <div class="mt-6" v-if="current_field_type !== 'password' && current_field_type !== 'number' && current_field_type !== 'enumeration'&& current_field_type !== 'boolean' && current_field_type !== 'date' && current_field_type !== 'time' && current_field_type !== 'media' && current_field_type !== 'relation' && current_field_type !== 'json'">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="w-full" v-if="current_field_type != 'password' && current_field_type != 'enumeration' && current_field_type != 'boolean' && current_field_type != 'date' && current_field_type != 'time' && current_field_type != 'media' && current_field_type != 'relation' && current_field_type != 'json' ">
                                <div class="flex items-start mt-2">
                                    <div class="flex items-center h-5">
                                        <input v-model="new_field.validations.unique.status" id="unique" type="checkbox" v-formcheckbox>
                                    </div>
                                    <div class="ml-3 text-sm">
                            ...
                            <div class="w-full" v-if="current_field_type != 'richtext' && current_field_type != 'enumeration' && current_field_type != 'boolean' && current_field_type != 'date' && current_field_type != 'time' && current_field_type != 'media' && current_field_type != 'relation' && current_field_type != 'json' ">
                                <div class="flex items-start mt-2">
                                    <div class="flex items-center h-5">
